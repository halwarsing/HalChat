### Важное юридическое уведомление для пользователей в Российской Федерации

Настоящее программное обеспечение (включая исходный код и сопутствующие компоненты) распространяется на условиях международной лицензии GNU General Public License версии 3 (GPLv3).

Для целей применения, толкования и защиты прав на территории Российской Федерации настоящая лицензия признается **открытой лицензией** в соответствии со **статьей 1286.1 Гражданского кодекса РФ**. Настоящая открытая лицензия является договором присоединения. 

Любое использование данного программного обеспечения (включая, но не ограничиваясь: скачивание, копирование, установку, запуск, воспроизведение, тиражирование или модификацию) означает полное и безоговорочное согласие (акцепт) со всеми условиями настоящей лицензии в соответствии со ст. 438 и ст. 1286.1 ГК РФ. Настоящая лицензия предоставляется на безвозмездной основе.

Официальным, аутентичным и единственным юридически обязывающим текстом лицензии является её оригинальная англоязычная версия, расположенная в файле `LICENSE`. Нижеследующий текст представляет собой **неофициальный информационный перевод** лицензии на русский язык, размещенный для удобства пользователей и во исполнение требований Федерального закона № 53-ФЗ «О государственном языке Российской Федерации». В случае любых разночтений, споров или противоречий между англоязычным оригиналом и данным переводом, юридическую силу имеет исключительно текст оригинала на английском языке.
...
Если для Программы явно указывается, что доверенное лицо может решать, какую из будущих версий Основной Общественной Лицензии GNU можно будет использовать, такое публичное заявление доверенного лица о принятии версии на постоянной основе уполномачивает вас делать выбор версии Лицензии для Программы.
