...
- [✅] **📌 Закрепленные сообщения и опросы:** Доработка функционала UI чата до полной синхронизации с Web-версией.
- [✅] **💡 Реакции:** Реакция на любые сообщения с помощью эмодзи.
