...
public class HalNetAPI {
    private static final String TAG="HALNETAPI";
    private static final String API_URL="https://halwarsing.net/api/api";
    ...
    public HalNetAPI(OkHttpClient client, String codeUser) {
        this.client=client;
    ...
    //Without User
    public static CompletableFuture<JSONObject> apiReqWU(String reqAction, JSONObject params) {
        CompletableFuture<JSONObject> future = new CompletableFuture<>();
        ...
        staticClient.newCall(request).enqueue(new Callback() {
            @Override
    ...
    private void executeRequest(Request request, CompletableFuture<JSONObject> future) {
