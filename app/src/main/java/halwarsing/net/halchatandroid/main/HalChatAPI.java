...
public class HalChatAPI {
    private static final String TAG="HALCHATAPI";
    private static final String API_URL="https://halchat.halwarsing.net/api";

    private final OkHttpClient client;
    private final String codeUser;

    public HalChatAPI(OkHttpClient client, String codeUser) {
        this.client=client;
            ...
            public void onResponse(Call call, Response response) {
                try {
                    ...
                    try {
                        ...
                        Log.e(TAG,"HCAPI Error: "+responseData,e);
                        future.completeExceptionally(e);
                    }
